...
N = 10;
q3_offset_list = linspace(0, pi, N);

for i = 1:N
    fplot(q3_bounds(1)+q3_offset_list(i), [-pi, pi], color=diagrams.colors.green);
end
...
for i = 1:N
    r_i = subs(r, q3_sym, q3_bounds(1)+q3_offset_list(i));
    z_i = subs(z, q3_sym, q3_bounds(1)+q3_offset_list(i));
    fplot(r_i, z_i, color=diagrams.colors.green);
    % fplot(q3_bounds(1)+q3_offset_list(i), [-pi, pi], color=diagrams.colors.green);
end
